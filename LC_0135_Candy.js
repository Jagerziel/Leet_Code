...
console.log(candy(ratings01))
console.log(candy(ratings02))
console.log(candy(ratings03))
console.log(candy(ratings04))
console.log(candy(ratings05))
console.log(candy(ratings06))
console.log(candy(ratings07))
console.log(candy(ratings08))
console.log(candy(ratings09))
console.log(candy(ratings10))
console.log(candy(ratings11))